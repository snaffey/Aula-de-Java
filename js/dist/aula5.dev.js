...
var Pessoa = function Pessoa(n, c) {
  this.nome = n;
  if (c) this.contacto = c;
};
...
Pessoa.prototype = {
  ...
  imprimeNome: function imprimeNome() {
...
p1.imprimeNome(); //Retorna o objeto literal, não é necessário operador new

var Pessoa2 = function Pessoa2(nm, cont) {
  return {
    nome: nm,
    contacto: cont,
    imprimeNome: function imprimeNome() {
